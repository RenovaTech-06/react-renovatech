...
<div className="container mx-auto w-full  justify-center max-w-sm  p-4 bg-white  rounded-lg  sm:p-6 md:p-8 ">
    <form className="space-y-6" onSubmit={login}>
        ...
        <button type="submit" className="w-full text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" >Login to your account</button>
