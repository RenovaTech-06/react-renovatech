        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100 ">
          <div className="container mx-auto w-full max-w-sm p-4 bg-gray-50 rounded-lg sm:p-6 md:p-8 shadow-xl">
            <form className="space-y-6" onSubmit={login}>
              ...
              <button
                type="submit"
                className="w-full text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 flex justify-center text-center"
              >
                {isLoading ? (
                  <RotatingLines
                    strokeColor="white"
